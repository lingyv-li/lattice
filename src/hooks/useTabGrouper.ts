...
export const useTabGrouper = () => {
    ...
    useEffect(() => {
        ...
        // Performance: Debounce tab events to prevent excessive WindowSnapshot generation
        // during rapid updates (e.g. page loads, restoring sessions).
        // args are ignored as we just need to trigger a scan.
        const handleTabEvent = debounce((..._args: unknown[]) => scanUngrouped(), 300);
