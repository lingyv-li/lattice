...
export const SuggestionItem: React.FC<SuggestionItemProps> = ({
    ...
    return (
        ...
        `} >
            ...
            <button
                type="button"
                className="w-full text-left flex items-center gap-2 p-2 cursor-pointer focus-visible:ring-2 focus-visible:ring-action focus-visible:ring-inset focus:outline-none"
                onClick={onClick}
                disabled={disabled}
                aria-busy={isLoading}
            >
