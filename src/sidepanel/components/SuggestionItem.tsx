...
export const SuggestionItem: React.FC<SuggestionItemProps> = ({ title, description, icon: Icon, type, onClick, isLoading, disabled, tabs }) => {
    ...
    return (
        ...
        >
            ...
            <button
                type='button'
                className='w-full text-left flex items-center gap-2 p-2 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-action focus-visible:ring-inset'
                onClick={onClick}
