        ...
        duplicateGroups.forEach((tabs, url) => {
            if (tabs.length > 1) {
                ...
                list.push({
                    ...
                    displayTabs: duplicateTabs.map(t => ({ title: t.title, url: t.url, favIconUrl: t.favIconUrl }))
                });
            }
        });
        ...
        if (previewGroups) {
            previewGroups.forEach((group, index) => {
                ...
                list.push({
                    ...
                    displayTabs: groupTabs.map(t => ({ title: t.title, url: t.url, favIconUrl: t.favIconUrl }))
                });
            });
        }
