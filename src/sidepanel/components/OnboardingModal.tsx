    ...
    return (
        <div className='bg-surface border border-border-subtle rounded-2xl shadow-2xl max-w-2xl w-full'>
            ...
            <div className='p-8 min-h-[400px]'>
                ...
                {step === OnboardingStep.Complete && <OnboardingComplete selectedProvider={selectedProvider} />}
            </div>
            ...
            <div className='p-8 border-t border-border-subtle bg-surface/50 backdrop-blur-sm rounded-b-2xl'>
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <button
                        ...
                        className={`px-8 py-3 rounded-xl text-sm font-bold transition-all flex items-center gap-2 shadow-lg active:scale-95 ${
